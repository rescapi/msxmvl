...
| [Asset Pipeline](docs/Asset-Pipeline.md) | `img2tiles`, `img2bitmap`, `img2sprites`, `gentables` | turn your own PNGs into SCREEN 2 tiles, SCREEN 5/7/8/12 bitmaps or hardware sprites, and bake sin/cos/atan tables — build-time tools, golden-tested |
