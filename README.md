...
| [Asset Pipeline](docs/Asset-Pipeline.md) | `img2tiles`, `img2bitmap`, `img2sprites`, `gentables` | turn your own PNGs into SCREEN 2 tiles, SCREEN 5/7/8/12 bitmaps or hardware sprites (optionally **ZX0-packed**), and bake sin/cos/atan tables — build-time tools, golden-tested |
...
| [Compression](docs/Compression.md) | `compress`, `unzx0`/`unzx7`/`unpletter`/`unlzsa2` | unpack RLEp, **ZX0** (+ VRAM), ZX7, Pletter or LZSA2 — clean-room, measured, to fit more into the ROM |
...
| [ROM Formats](docs/ROM-Formats.md) | `crt0_rom*` | 16 / 32 / 48 KB cartridges — one flag picks the startup |
